 ...
 * @author opus
 */
public class EO2FieldsPanel extends javax.swing.JPanel implements TableModelListener{

    private static final Logger log = Logger.getLogger(EO2FieldsPanel.class.getName());
    
    protected EO2FieldsWrapper cfw;
    
    
    EO2FieldsPanel(EO2FieldsWrapper cfw) {
    ...
    private void addRow(){
        ...
        if(srow == -1){
            cfw.add(EO2Field.EO2FieldFactory(cfw.size()));
        }
        else{
            cfw.add(srow, EO2Field.EO2FieldFactory(cfw.size()));
        }
    ...
    private void riseRow(){
        ...
        int srow=jtbl_fields.getSelectedRow();
         ...
         if(srow > 0){
             EO2Field thisrow = cfw.get(srow);
             EO2Field previousrow = cfw.get(srow-1);
        ...
        public void setValueAt(Object value, int row, int column) {
            ...
            switch (column) {
                case 0:
                    ...
                    break;
                case 1:
                    csvf.setRecord((String)value);
                    break;
                case 2:
                    csvf.setFieldindex((Integer)value);
                    break;
    ...
    private void loadTemplate(){
        ...
        if (s !=null){
            try {
                ...
                EO2FieldsWrapper tmpl = gson.fromJson(payload, EO2FieldsWrapper.class);
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, "   Filtro EO2 - Edição do gabarito de campos"); // NOI18N
        jLabel1.setToolTipText(org.openide.util.NbBundle.getMessage(EO2FieldsPanel.class, "EO2FieldsPanel.jLabel1.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(bt_sub, org.openide.util.NbBundle.getMessage(EO2FieldsPanel.class, "EO2FieldsPanel.bt_sub.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(bt_up, org.openide.util.NbBundle.getMessage(EO2FieldsPanel.class, "EO2FieldsPanel.bt_up.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(bt_down, org.openide.util.NbBundle.getMessage(EO2FieldsPanel.class, "EO2FieldsPanel.bt_down.text")); // NOI18N

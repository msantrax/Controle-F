...
public class EO2FieldPropertyEditor extends PropertyEditorSupport implements ExPropertyEditor {    

    private static final Logger log = Logger.getLogger(EO2FieldPropertyEditor.class.getName());
    ...
    public void attachEnv(PropertyEnv pe) {
       ...
       EO2FilterNode cfn = (EO2FilterNode) beans[0];
       cfw = cfn.getCfw();      
       log.info(String.format("Attaching EO2 env : %d with %d fields", cfw.hashCode(), cfw.size()));
    }  

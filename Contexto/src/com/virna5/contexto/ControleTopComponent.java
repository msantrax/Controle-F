...
public final class ControleTopComponent extends TopComponent {
    ...
    private void initComponents() {
        ...
        tbl_running.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Conversor QS4", "23-05-2016 23:45:15", "msantos",  new Boolean(true), "FileObserver", "Conversor de resultados via arquivo CSV"},
                {"Simulador de Resultados", null, "msantos",  new Boolean(false), "Gerador de Resultados", "Ferramanta de testes"},

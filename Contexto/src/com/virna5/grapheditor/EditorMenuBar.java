...
import com.virna5.grapheditor.EditorActions.AlignCellsAction;
import com.virna5.grapheditor.EditorActions.AutosizeAction;
import com.virna5.grapheditor.EditorActions.BackgroundAction;
import com.virna5.grapheditor.EditorActions.BackgroundImageAction;
import com.virna5.grapheditor.EditorActions.ColorAction;
import com.virna5.grapheditor.EditorActions.ExitAction;
import com.virna5.grapheditor.EditorActions.GridColorAction;
import com.virna5.grapheditor.EditorActions.GridStyleAction;
import com.virna5.grapheditor.EditorActions.HistoryAction;
import com.virna5.grapheditor.EditorActions.ImportAction;
...
import com.virna5.grapheditor.EditorActions.PageBackgroundAction;
import com.virna5.grapheditor.EditorActions.PageSetupAction;
import com.virna5.grapheditor.EditorActions.PrintAction;
import com.virna5.grapheditor.EditorActions.PromptPropertyAction;
import com.virna5.grapheditor.EditorActions.PromptValueAction;
import com.virna5.grapheditor.EditorActions.SaveAction;
import com.virna5.grapheditor.EditorActions.ScaleAction;
import com.virna5.grapheditor.EditorActions.SelectShortestPathAction;
import com.virna5.grapheditor.EditorActions.SelectSpanningTreeAction;
import com.virna5.grapheditor.EditorActions.SetLabelPositionAction;
import com.virna5.grapheditor.EditorActions.SetStyleAction;
import com.virna5.grapheditor.EditorActions.StyleAction;
import com.virna5.grapheditor.EditorActions.StylesheetAction;
import com.virna5.grapheditor.EditorActions.ToggleAction;
import com.virna5.grapheditor.EditorActions.ToggleConnectModeAction;
import com.virna5.grapheditor.EditorActions.ToggleCreateTargetItem;
import com.virna5.grapheditor.EditorActions.ToggleDirtyAction;
import com.virna5.grapheditor.EditorActions.ToggleGridItem;
import com.virna5.grapheditor.EditorActions.ToggleOutlineItem;
import com.virna5.grapheditor.EditorActions.TogglePropertyItem;
import com.virna5.grapheditor.EditorActions.ToggleRulersItem;
import com.virna5.grapheditor.EditorActions.WarningAction;
import com.virna5.grapheditor.EditorActions.ZoomPolicyAction;
...
public class EditorMenuBar extends JMenuBar
{
	...
	public EditorMenuBar(final BasicGraphEditor editor)
	{
		...
		menu.add(editor.bind(mxResources.get("new"), new NewAction(), "/com/virna5/graphimages/new.gif"));
		menu.add(editor.bind(mxResources.get("openFile"), new OpenAction(), "/com/virna5/graphimages/open.gif"));
		menu.add(editor.bind(mxResources.get("importStencil"), new ImportAction(), "/com/virna5/graphimages/open.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("save"), new SaveAction(false), "/com/virna5/graphimages/save.gif"));
		menu.add(editor.bind(mxResources.get("saveAs"), new SaveAction(true), "/com/virna5/graphimages/saveas.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("pageSetup"), new PageSetupAction(), "/com/virna5/graphimages/pagesetup.gif"));
		menu.add(editor.bind(mxResources.get("print"), new PrintAction(), "/com/virna5/graphimages/print.gif"));
		...
		menu.add(editor.bind(mxResources.get("undo"), new HistoryAction(true), "/com/virna5/graphimages/undo.gif"));
		menu.add(editor.bind(mxResources.get("redo"), new HistoryAction(false), "/com/virna5/graphimages/redo.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("cut"), TransferHandler.getCutAction(), "/com/virna5/graphimages/cut.gif"));
		menu.add(editor.bind(mxResources.get("copy"), TransferHandler.getCopyAction(), "/com/virna5/graphimages/copy.gif"));
		menu.add(editor.bind(mxResources.get("paste"), TransferHandler.getPasteAction(), "/com/virna5/graphimages/paste.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("delete"), mxGraphActions.getDeleteAction(), "/com/virna5/graphimages/delete.gif"));
		...
		submenu.add(editor.bind(mxResources.get("basicStyle"),
				new StylesheetAction("/com/virna5/graphresources/basic-style.xml")));
	...
	{
		menu.add(editor.bind(mxResources.get("home"), mxGraphActions.getHomeAction(), "/com/virna5/graphimages/house.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("exitGroup"), mxGraphActions.getExitGroupAction(), "/com/virna5/graphimages/up.gif"));
		menu.add(editor.bind(mxResources.get("enterGroup"), mxGraphActions.getEnterGroupAction(),
				"/com/virna5/graphimages/down.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("group"), mxGraphActions.getGroupAction(), "/com/virna5/graphimages/group.gif"));
		menu.add(editor.bind(mxResources.get("ungroup"), mxGraphActions.getUngroupAction(),
				"/com/virna5/graphimages/ungroup.gif"));
		...
		menu.add(editor.bind(mxResources.get("collapse"), mxGraphActions.getCollapseAction(),
				"/com/virna5/graphimages/collapse.gif"));
		menu.add(editor.bind(mxResources.get("expand"), mxGraphActions.getExpandAction(), "/com/virna5/graphimages/expand.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("toBack"), mxGraphActions.getToBackAction(), "/com/virna5/graphimages/toback.gif"));
		menu.add(editor.bind(mxResources.get("toFront"), mxGraphActions.getToFrontAction(),
				"/com/virna5/graphimages/tofront.gif"));
	...
	public static void populateFormatMenu(JMenu menu, BasicGraphEditor editor)
	{
		...
		submenu.add(editor.bind(mxResources.get("straight"), new SetStyleAction("straight"),
				"/com/virna5/graphimages/straight.gif"));

		submenu.add(editor.bind(mxResources.get("horizontal"), new SetStyleAction(""), "/com/virna5/graphimages/connect.gif"));
		submenu.add(editor.bind(mxResources.get("vertical"), new SetStyleAction("vertical"),
				"/com/virna5/graphimages/vertical.gif"));

		submenu.addSeparator();

		submenu.add(editor.bind(mxResources.get("entityRelation"), new SetStyleAction("edgeStyle=mxEdgeStyle.EntityRelation"),
				"/com/virna5/graphimages/entity.gif"));
		submenu.add(editor.bind(mxResources.get("arrow"), new SetStyleAction("arrow"), "/com/virna5/graphimages/arrow.gif"));
		...
		submenu.add(editor.bind(mxResources.get("open"), new KeyValueAction(mxConstants.STYLE_STARTARROW, mxConstants.ARROW_OPEN),
				"/com/virna5/graphimages/open_start.gif"));
		...
		submenu.add(editor.bind(mxResources.get("top"), new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN, mxConstants.ALIGN_TOP),
				"/com/virna5/graphimages/top.gif"));
		submenu.add(editor.bind(mxResources.get("middle"), new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN, mxConstants.ALIGN_MIDDLE),
				"/com/virna5/graphimages/middle.gif"));
		submenu.add(editor.bind(mxResources.get("bottom"), new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN, mxConstants.ALIGN_BOTTOM),
				"/com/virna5/graphimages/bottom.gif"));

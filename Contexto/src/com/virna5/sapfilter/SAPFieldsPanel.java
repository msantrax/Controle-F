 ...
 * @author opus
 */
public class SAPFieldsPanel extends javax.swing.JPanel implements TableModelListener{

    private static final Logger log = Logger.getLogger(SAPFieldsPanel.class.getName());
    
    protected SAPFieldsWrapper cfw;
    
    
    SAPFieldsPanel(SAPFieldsWrapper cfw) {
    ...
    private void addRow(){
        ...
        if(srow == -1){
            cfw.add(SAPField.SAPFieldFactory(cfw.size()));
        }
        else{
            cfw.add(srow, SAPField.SAPFieldFactory(cfw.size()));
        }
    ...
    private void riseRow(){
        ...
        int srow=jtbl_fields.getSelectedRow();
         ...
         if(srow > 0){
             SAPField thisrow = cfw.get(srow);
             SAPField previousrow = cfw.get(srow-1);
    ...
    private void loadTemplate(){
        ...
        if (s !=null){
            try {
                ...
                SAPFieldsWrapper tmpl = gson.fromJson(payload, SAPFieldsWrapper.class);
    ...
    private void initComponents() {
        ...
        jLabel1.setToolTipText(org.openide.util.NbBundle.getMessage(SAPFieldsPanel.class, "SAPFieldsPanel.jLabel1.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(bt_sub, org.openide.util.NbBundle.getMessage(SAPFieldsPanel.class, "SAPFieldsPanel.bt_sub.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(bt_up, org.openide.util.NbBundle.getMessage(SAPFieldsPanel.class, "SAPFieldsPanel.bt_up.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(bt_down, org.openide.util.NbBundle.getMessage(SAPFieldsPanel.class, "SAPFieldsPanel.bt_down.text")); // NOI18N

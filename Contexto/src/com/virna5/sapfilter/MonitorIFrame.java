...
public class MonitorIFrame extends JInternalFrame implements MonitorIFrameInterface{
    ...
    private SAPFilterDescriptor descriptor;
    private SAPFilterService service;
    ...
    public void setDescriptor(BaseDescriptor _descriptor) {
        this.descriptor = (SAPFilterDescriptor)_descriptor;
     ...
     * @return the descriptor
     */
    public SAPFilterService getService() {
        return service;
    }
    ...
    public void setService(BaseService _service) {
        this.service = (SAPFilterService)_service;
    }

...
import com.virna5.grapheditor.SchemaEditorMenuBar;
import com.virna5.grapheditor.SchemaEditorToolBar;
import com.virna5.grapheditor.SchemaGraphComponent;
...
public class SchemaEditor extends BasicGraphEditor {
    ...
    public SchemaEditor() {
        ...
        shapesPalette.addTemplate(
                        "Table",
                        new ImageIcon(GraphEditor.class.getResource("/com/virna5/graphimages/rectangle.png")),tableTemplate);

...
public class AlloyFieldsPropertyEditor extends PropertyEditorSupport implements ExPropertyEditor {    

    private static final Logger log = Logger.getLogger(AlloyFieldsPropertyEditor.class.getName());
  
    protected AlloyFilters alloys; 
    ...
    public void attachEnv(PropertyEnv pe) {
        ...
        alloys = cfn.getAlloyfilters();
       
        if (alloys == null){
            alloys = new AlloyFilters();
        }
        log.info(String.format("Attaching Interceptpr env : %d with %d fields", alloys.hashCode(), alloys.size()));
    }  
    
    
    @Override
    public String getAsText() {
        return String.format("%d Ligas", alloys.size());
    }
    ...
    public Component getCustomEditor() {
        return new AlloyFieldsPanel(alloys);
    }

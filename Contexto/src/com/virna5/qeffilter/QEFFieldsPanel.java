 ...
 * @author opus
 */
public class QEFFieldsPanel extends javax.swing.JPanel implements TableModelListener{

    private static final Logger log = Logger.getLogger(QEFFieldsPanel.class.getName());
    
    protected QEFFieldsWrapper cfw;
    
    
    QEFFieldsPanel(QEFFieldsWrapper cfw) {
    ...
    private void addRow(){
        ...
        if(srow == -1){
            cfw.add(QEFField.QEFFieldFactory(cfw.size()));
        }
        else{
            cfw.add(srow, QEFField.QEFFieldFactory(cfw.size()));
        }
    ...
    private void riseRow(){
        ...
        int srow=jtbl_fields.getSelectedRow();
         ...
         if(srow > 0){
             QEFField thisrow = cfw.get(srow);
             QEFField previousrow = cfw.get(srow-1);
    ...
    final TableModel model = new AbstractTableModel(){
        ...
        public Object getValueAt(int row, int column) {
            ...
            switch (column) {
                case 0:
                    ...
                    break;
                case 1:
                    o=QEFField.convertField(csvf.getWindow());
                    break;    
                case 2:
                    o= csvf.getPercent();
                    break;      
                case 3:
                    o=QEFField.convertField(csvf.getLimitlow());
                    break;   
                case 4:
                    o=QEFField.convertField(csvf.getLimithigh());
                    break;       
        ...
        public void setValueAt(Object value, int row, int column) {
            ...
            switch (column) {
                case 0:
                    ...
                    break;
                case 1:
                    csvf.setWindow(QEFField.encodeField((String)value));
                    break;
                case 2:
                    csvf.setPercent((Boolean)value);
                    break;
                case 3:
                    csvf.setLimitlow(QEFField.encodeField((String)value));
                    break;    
                case 4:
                    csvf.setLimithigh(QEFField.encodeField((String)value));
                    break;    
        ...
        String[] cnames = new String[]{
           "ID do Campo", "Janela", "%", "Limite inf.", "Limite sup."  
        };
    ...
    private void loadTemplate(){
        ...
        if (s !=null){
            try {
                ...
                QEFFieldsWrapper tmpl = gson.fromJson(payload, QEFFieldsWrapper.class);
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, "   Filtro QEF - Edição do gabarito de campos"); // NOI18N
        jLabel1.setToolTipText(org.openide.util.NbBundle.getMessage(QEFFieldsPanel.class, "QEFFieldsPanel.jLabel1.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(bt_sub, org.openide.util.NbBundle.getMessage(QEFFieldsPanel.class, "QEFFieldsPanel.bt_sub.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(bt_up, org.openide.util.NbBundle.getMessage(QEFFieldsPanel.class, "QEFFieldsPanel.bt_up.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(bt_down, org.openide.util.NbBundle.getMessage(QEFFieldsPanel.class, "QEFFieldsPanel.bt_down.text")); // NOI18N

...
public class QEFFieldPropertyEditor extends PropertyEditorSupport implements ExPropertyEditor {    

    private static final Logger log = Logger.getLogger(QEFFieldPropertyEditor.class.getName());
    ...
    public void attachEnv(PropertyEnv pe) {
       ...
       QEFFilterNode cfn = (QEFFilterNode) beans[0];
       cfw = cfn.getCfw();      
       log.info(String.format("Attaching QEF env : %d with %d fields", cfw.hashCode(), cfw.size()));
    }  
